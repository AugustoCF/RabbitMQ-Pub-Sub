...
const publicKey1 = fs.readFileSync('public_key_space_trip.pem', 'utf8');
const publicKey2 = fs.readFileSync('public_key_star_cross.pem', 'utf8');
...
amqp.connect('amqp://localhost', function(error0, connection) {
  ...
  connection.createChannel(function(error1, channel) {
    ...
    channel.assertQueue('', { exclusive: true }, function(error2, q) {
      ...
      const bindingKeys = ['*.venus', 'padrao.*'];
